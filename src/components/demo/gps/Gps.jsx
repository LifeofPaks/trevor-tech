...
const Gps = () => {
  ...
  return (
    <>
      ...
      <Box className="!p-6 !bg-gray-50 overflow-hidden">
        {/* Tabs + Date */}
        <Box className="!mb-2">
          <Stack
            direction="row"
          ...
          >
            <Tabs
              ...
              sx={{
                ...
                "& .Mui-selected": { color: "#0695c8 !important" },
                "& .MuiTabs-indicator": {
                ...
                <TableBody>
                  {gpsData.map((row, i) => (
                    ...
                    >
                      ...
                      {/* Address with truncation on mobile */}
                      <TableCell
                        sx={{
          ...
          <Box className="!h-full !min-h-96 !rounded-lg !overflow-hidden relative">
            ...
            {selectedLocation && (
              <Box
                ...
                sx={{ minWidth: 200, border: "1px solid #e5e7eb" }}
              >
                <Typography
                  variant="subtitle2"
                  fontWeight="bold"
