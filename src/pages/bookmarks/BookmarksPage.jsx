        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between !gap-3 sm:!gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center !gap-2 sm:!gap-3">
            <span className="text-[10px] sm:text-xs text-orange-600 bg-orange-100 !px-3 sm:!px-4 !py-1.5 sm:!py-2 rounded-full font-medium">
              {t("dmbookmark.header.demo_message")}
            </span>
            <button
              onClick={handleOpen}
              ...
              aria-label={t("dmbookmark.header.bind_button_aria")}
            >
              {t("dmbookmark.header.bind_button")}
            </button>
          </div>
        </div>
      </header>
        ...
        <Box className="!flex justify-center !mt-6">
          <Stack direction="row" spacing={1} alignItems="center">
            <IconButton
              ...
              aria-label={t("dmbookmark.pagination.previous_aria")}
            >
              <FiChevronLeft />
            </IconButton>
            ...
            {[...Array(totalPages)].map((_, i) => (
              <Chip
                ...
                aria-label={t("dmbookmark.pagination.page_aria", {
                  page: i + 1,
                })}
              />
            ))}
            ...
            <IconButton
              ...
              aria-label={t("dmbookmark.pagination.next_aria")}
            >
              <FiChevronRight />
            </IconButton>
          </Stack>
