...
const NeuralCryptoScanner = ({ recovered }) => {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="relative lg:!w-80 lg:!h-80 w-76 h-76 cursor-grab active:cursor-grabbing lg:my-0 !my-10"
...
const RecoveryMatrix = ({ isActive, t }) => {
  ...
  return (
    <motion.div
      className="bg-black/85 backdrop-blur-3xl border border-cyan-500/40 rounded-2xl !p-6 font-mono text-xs !h-80 overflow-hidden shadow-2xl w-[350px] !mb-10"
