...
const wifiData = [
  {
    ...
    nameKey: "dmwifi.networks.0.name",
  ...
  },
  {
    ...
    nameKey: "dmwifi.networks.1.name",
  ...
  },
  {
    ...
    nameKey: "dmwifi.networks.2.name",
  ...
  },
  {
    ...
    nameKey: "dmwifi.networks.3.name",
  ...
  },
  {
    ...
    nameKey: "dmwifi.networks.4.name",
  ...
  },
  {
    ...
    nameKey: "dmwifi.networks.5.name",
  ...
  },
  {
    ...
    nameKey: "dmwifi.networks.6.name",
  ...
  },
  {
    ...
    nameKey: "dmwifi.networks.7.name",
  ...
  },
  {
    ...
    nameKey: "dmwifi.networks.8.name",
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between !gap-3 sm:!gap-4">
          <div className="flex items-center !gap-2 sm:!gap-3">
            <h1 className="text-lg sm:text-lg md:text-xl font-bold text-slate-800 flex items-center !gap-2">
              {t("dmwifi.header.title")} <FaWifi className="text-[#0695c8]" />
            </h1>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center !gap-2 sm:!gap-3">
            ...
            <button
              ...
              aria-label={t("dmwifi.header.bind_button_aria")}
            >
              {t("dmwifi.header.bind_button")}
            </button>
          </div>
        </div>
      </header>
        ...
        <Box className="!mb-8">
          ...
          >
            <Stack direction="row" spacing={2} alignItems="center">
              ...
              >
                <FiCalendar className="!text-gray-500 lg:!text-sm !text-[11px]" />
                <Typography className="!text-gray-700 !font-medium lg:!text-sm !text-[11px]">
                  {t("dmwifi.header.date_range", {
              ...
              <Chip
                label={t("dmwifi.header.last_7_days")}
                size="small"
                sx={{
              ...
              <TableHead>
                <TableRow sx={{ backgroundColor: "#f9fafb" }}>
                  {[
                    "dmwifi.table.bssid",
                    "dmwifi.table.name",
                    "dmwifi.table.connected",
                    "dmwifi.table.latitude",
                    "dmwifi.table.longitude",
                  ].map((headerKey) => (
                    <TableCell
                      key={headerKey}
                      sx={{
                        ...
                        textAlign:
                          headerKey === "dmwifi.table.latitude" ||
                          headerKey === "dmwifi.table.longitude"
                            ? "center"
                            : "left",
                        borderBottom: "none",
                      }}
        ...
        <Box className="!flex justify-center">
          <Stack direction="row" spacing={1} alignItems="center">
            <IconButton
              ...
              aria-label={t("dmwifi.pagination.prev_button_aria")}
            >
              <FiChevronLeft />
            </IconButton>
            <Chip
            ...
            <IconButton
              ...
              aria-label={t("dmwifi.pagination.next_button_aria")}
            >
              <FiChevronRight />
            </IconButton>
          </Stack>
