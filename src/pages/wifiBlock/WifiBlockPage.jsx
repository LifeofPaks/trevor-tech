      ...
      <header className="!mb-4 sm:!mb-6 !px-4">
        ...
        <Box className="!p-6 !bg-gray-50 !mt-6">
          ...
          <Paper
            ...
            aria-label={t("dmwifiblocker.table.aria_label")}
          >
            {/* Header */}
            <Box
              sx={{
            ...
            >
              <Typography className="!font-semibold !text-xs !text-gray-600 uppercase tracking-wider">
                {t("dmwifiblocker.table.title")}
              </Typography>
              {!isMobile && (
                <>
                  <Typography className="!font-semibold !text-xs !text-gray-600 uppercase tracking-wider">
                    {t("dmwifiblocker.table.connected_time")}
                  </Typography>
                  <Typography className="!font-semibold !text-xs !text-gray-600 uppercase tracking-wider">
                    {t("dmwifiblocker.table.latitude")}
                  </Typography>
                  <Typography className="!font-semibold !text-xs !text-gray-600 uppercase tracking-wider">
                    {t("dmwifiblocker.table.longitude")}
                  </Typography>
                </>
              )}
              <Typography className="!font-semibold !text-xs !text-gray-600 uppercase tracking-wider text-right">
                {t("dmwifiblocker.table.block_status")}
              </Typography>
            </Box>
              ...
              {wifiList.map((wifi) => (
                ...
                >
                  ...
                  <Typography className="!text-sm !font-medium !text-gray-900">
                    {isMobile
                      ? t(`dmwifiblocker.wifi.${wifi.titleKey}`).length > 8
                        ? t(`dmwifiblocker.wifi.${wifi.titleKey}`).slice(0, 8) +
                          "..."
                        : t(`dmwifiblocker.wifi.${wifi.titleKey}`)
                      : t(`dmwifiblocker.wifi.${wifi.titleKey}`)}
                  </Typography>
                  ...
                  <Box className="!flex !justify-end">
                    <Button
                      ...
                      sx={{
                        ...
                        "&:hover": {
                          backgroundColor: wifi.blocked ? "#059669" : "#dc2626",
                        },
                      }}
                      aria-label={t(
                        wifi.blocked
                          ? "dmwifiblocker.table.unblock_button_aria"
                          : "dmwifiblocker.table.block_button_aria",
                        { title: t(`dmwifiblocker.wifi.${wifi.titleKey}`) }
                      )}
                    >
                      {t(
                        wifi.blocked
                          ? "dmwifiblocker.table.unblock_button"
                          : "dmwifiblocker.table.block_button"
                      )}
                    </Button>
                  </Box>
                </Box>
